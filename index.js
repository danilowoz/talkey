...
//  Component
//
class Button extends Talkey.Component {
  constructor(props) {
    super(props);
  }
...
class App extends Talkey.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        ...
        {this.state.counter < 10 && <Button onClick={this.add}>+ add</Button>}
      </div>
    );
  }
}
